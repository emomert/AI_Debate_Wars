...
| Price/margin mismatch | Fixed match quotes; accurate cost estimates kept separate from restored original coin prices |
...
- Provider invoices and future tariffs can differ from application estimates. Maintain balances/alerts and review actual costs against observed net revenue without automatically repricing coins.
