...
export const legal = {
  ...
  privacyPage: {
    ...
    sections: [
      { heading: "1. Neleri topluyoruz", body: "Canlı maçlar için giriş gerekir. E-posta adresinizi, maç konusu ve ayarlarını, üretilen argüman ve kararları, fiyat tekliflerini ve kullanım/maliyet verilerini saklarız. Üretim kayıtları, maçları güvenle sürdürmemizi ve tekrarlanan isteklere mevcut yanıtı döndürmemizi sağlar. Maçı profilinize kaydetmek ayrı bir işlemdir." },
      ...
      { heading: "5. Saklama ve silme", body: "Kaydedilen maçlar siz silene kadar saklanır. Kaydedilmiş bir maçı silmek onu geçmişinizden kaldırır; ayrı üretim kaydı, tekrar üretimi ve ücretlendirmeyi önlemek için tutulur. Hesap dışa aktarımı bu üretim kayıtlarını da içerir. Hesabınızı silmek üretim kayıtlarını da siler. Erişim veya silme talepleri için aşağıdaki iletişim adresine yazabilirsiniz." },
