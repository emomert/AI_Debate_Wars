...
export const legal = {
  ...
  privacyPage: {
    ...
    sections: [
      ...
      { heading: "5. Saklama ve silme", body: "Kaydedilen maçlar, siz silene kadar saklanır. Maçları tek tek profilinizden silebilir, hesabınızın ve verilerinizin silinmesini aşağıda gösterilen iletişim adresinden talep edebilirsiniz." },
