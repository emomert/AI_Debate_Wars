...
export const legal = {
  ...
  effective: "Yürürlük: Haziran 2026",
  reviewNote:
  ...
  termsPage: {
    ...
    sections: [
      { heading: "1. Debator nedir", body: "Debator, üçüncü taraf yapay zekâ modelleri arasında yapılandırılmış münazara ve tartışmalar düzenleyen bir eğlence ve eğitim aracıdır. Olduğu gibi, kişisel ve ticari olmayan kullanım için sunulur." },
      ...
      { heading: "7. Değişiklikler", body: "Bu şartları güncelleyebiliriz; değişiklikten sonra kullanmaya devam etmeniz kabul ettiğiniz anlamına gelir." },
      { heading: "8. İletişim", body: "Bu şartlarla ilgili sorularınız mı var? Sitedeki iletişim bilgilerinden bize ulaşın." },
    ],
  },
  privacyPage: {
    ...
    sections: [
      ...
      { heading: "2. Konular ve üçüncü taraflar", body: "Gönderdiğiniz konular, münazarayı üreten yapay zekâ sağlayıcılarına (ör. OpenAI, DeepSeek, OpenRouter) ve Derin Münazara için bir web arama sağlayıcısına (Brave) gönderilir. Bu verileri işlemeleri, kendi gizlilik politikalarına tabidir." },
      { heading: "3. Çerezler", body: "Yalnızca zorunlu çerezleri kullanırız: bir kimlik doğrulama çerezi (giriş yaparsanız) ve dil tercihinizi hatırlayan küçük bir çerez. Üçüncü taraf reklam ya da takip çerezi yoktur." },
      ...
      { heading: "5. Saklama ve silme", body: "Kaydedilen maçlar, siz ya da hesabınız silene kadar saklanır. Sitedeki iletişim bilgilerinden hesabınızın ve verilerinizin silinmesini talep edebilirsiniz." },
      { heading: "6. Haklarınız", body: "Verilerinize erişebilir, dışa aktarabilir veya silebilirsiniz. Yaşadığınız yere bağlı olarak GDPR veya KVKK gibi yasalar kapsamında ek haklarınız olabilir." },
      { heading: "7. Değişiklikler ve iletişim", body: "Bu politikayı güncelleyebiliriz; önemli değişiklikler burada belirtilir. Sorularınız için sitedeki iletişim bilgilerini kullanın." },
    ],
  },
};
