...
export const legal = {
  ...
  privacyPage: {
    ...
    sections: [
      { heading: "1. What we collect", body: "Live matches require sign-in. We store your email address, match topics and settings, generated arguments and verdicts, price quotes, and usage/cost metadata. Generation records let us resume matches safely and return an existing answer when a request is repeated. Saving a match to your profile is a separate action." },
      ...
      { heading: "5. Retention & deletion", body: "Saved matches stay until you delete them. Deleting a saved match removes it from your history; its separate generation record is retained to prevent duplicate generation and charging. Your account export includes those generation records. Deleting your account also deletes its generation records. You can request access or deletion at the contact address below." },
