...
export const legal = {
  ...
  privacyPage: {
    ...
    sections: [
      ...
      { heading: "5. Retention & deletion", body: "Saved matches stay until you delete them. You can delete individual matches from your profile, and request deletion of your account and data at the contact address shown below." },
